...
Sou desenvolvedor backend com foco em **Python, Django, AWS e Infraestrutura como Código com Terraform**. Tenho seis projetos reais em produção na nuvem, cobrindo diferentes arquiteturas cloud.

Atualmente cursando Engenharia de Software e me preparando para a certificação **AWS Solutions Architect Associate**.

🎯 **Objetivo:** Desenvolvedor Backend Jr. | Cloud Jr. | DevOps Jr.  
🔗 **LinkedIn:** [linkedin.com/in/flaviopx](https://www.linkedin.com/in/flaviopx)  
☁️ **Portfólio:** [fpx.dev](https://www.flaviopaixao.dev/)
...
![ECS](https://img.shields.io/badge/ECS-Containers-orange?style=flat&logo=amazonaws&logoColor=white)
